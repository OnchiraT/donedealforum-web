...
export function Hero() {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className={`absolute inset-0 bg-gradient-to-br from-gray-800 to-gray-900 transition-opacity duration-1000 ${videoLoaded ? 'opacity-0' : 'opacity-100'}`}>
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="animate-pulse text-white text-lg">กำลังโหลด...</div>
        </div>
      </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10">
        <div className="max-w-6xl mx-auto px-6 pb-12 text-center">
