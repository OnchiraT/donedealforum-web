...
export function Hero() {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      {/* Content at Bottom */}
      <div className={`absolute bottom-0 left-0 right-0 z-10 transition-all duration-1000 ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="max-w-6xl mx-auto px-6 pb-8 text-center">
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-3 drop-shadow-sm">
          ...
          <div className="flex flex-col items-center animate-bounce">
            <span className="text-sm text-gray-600 mb-1">เลื่อนลงเพื่อดูเพิ่มเติม</span>
